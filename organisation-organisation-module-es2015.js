...
const _c0 = function (a0, a1, a2) { return { "file-valid": a0, "file-invalid": a1, "no-validation": a2 }; };
...
OrganisationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: OrganisationComponent, selectors: [["app-organisation"]], decls: 17, vars: 4, consts: [[1, "container"], [1, "organisation-name"], [1, "row", "about-organisation"], ["class", "col-md-3 h-100", 4, "ngIf"], ["class", "col", 3, "ngClass", 4, "ngIf"], [1, "workspaces"], [1, "mycard"], [1, "mycard-title"], [1, "mycard-body"], [1, "card-text"], [3, "documents"], [1, "col-md-3", "h-100"], [1, "organisation-logo", "img-fluid", 3, "src", "alt"], [1, "col", 3, "ngClass"]], template: function OrganisationComponent_Template(rf, ctx) { if (rf & 1) {
